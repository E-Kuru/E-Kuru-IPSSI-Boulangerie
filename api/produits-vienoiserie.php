...
// URL à cibler
curl_setopt($curl, CURLOPT_URL, 'https://api.airtable.com/v0/appHPGSjJLGYA9Di1/Produits?filterByFormula=SEARCH(%22Viennoiserie%22%2C+%7BCategorie%7D)');
...
foreach($result->records as $record){
    echo '<p>Nom: '. $record->fields->Name."<br> Prix : ".$record->fields->Prix.' €</p>';
};
